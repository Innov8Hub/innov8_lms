  ...
  <div class="home">
    <div class="hero is-info is-medium" >
      <div class="hero-body has-text-centered">
        <h1 class="title" >Welcome to Innov8 Learn</h1>
        <h2 class="subtitle">An online place for lnnov8 Technology Hub Courses</h2>
      </div>
    </div>
  </div>
    ...
    <div class="container">
      <div class="columns is-multiline">
        ...
        <div class="column is-12 has-text-centered" >
          <a href="/courses" class="button is-info is-size-3 mt-6 mb-6">Click to get started</a>
        </div>
      </div>
    </div>
  </section>
